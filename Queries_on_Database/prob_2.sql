...
select index_1 as citing_index,citationindex_2 as cited_index,title,authorlist,year_of_publication,venue
from (citation left outer join research_paper on citation.citationindex_2 = research_paper.index) 
 left outer join paper_authorlist on citation.citationindex_2 = paper_authorlist.index
order by citing_index